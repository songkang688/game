 ...
 * 所以本款自己搭一份桩，只实现真正用到的那几样能力：建节点、挂/摘监听、
 * 排 rAF、读写 localStorage。`destroy.test.ts` 与 `platform12.test.ts`
 * 共用这一份 —— 两个文件各抄一遍的话，桩很快就会漂成两套。
 *
