...
@media (max-height:500px){
  ...
  /* r18:字号回 16、去 nowrap(360 正文守门);单行预算改用 line-clamp 钳 */
  .mj-goal{flex:0 0 auto;line-height:1.3;max-height:1.4em;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:1;overflow:hidden;}
