...
const tropicHand: RoundDef[] = [
  ...
  R(4, "雨林闪电战", 56, 28, 0.18, 0.05, 10, 3, 4, ["banana", "ice"], "雨林限时", "只有 28 秒的闪电战!"),
...
const frostHand: RoundDef[] = [
  ...
  R(5, "冷库快闪", 62, 30, 0.2, 0.05, 10, 3, 4, ["ice"], "冷库限时", "30 秒冷库快闪,别冻着手!"),
...
const nightHand: RoundDef[] = [
  ...
  R(6, "打烊前快切", 68, 30, 0.2, 0.06, 11, 3, 4, ["banana", "ice"], "夜市限时", "夜市要打烊了,30 秒抢切!"),
...
const volcanoHand: RoundDef[] = [
  ...
  R(7, "喷发前快切", 74, 28, 0.22, 0.07, 11, 3, 4, ["boom"], "火山限时", "火山要喷发!28 秒极速切"),
  R(7, "火山炸弹雨", 82, 46, 0.34, 0.1, 11, 2, 4, ["boom"], "火山炸弹雨", "炸弹最多的一回合,冷静!"),
  R(7, "双倍大家伙", 84, 46, 0.22, 0.15, 11, 2, 4, ["boom"], "大炸弹狂潮", "大炸弹成群出没!"),
...
const royalHand: RoundDef[] = [
  ...
  R(8, "精准快刀试炼", 82, 40, 0.26, 0.08, 11, 3, 4, ["banana", "ice"], "精准冲刺", "时间紧目标高,刀刀要切准!"),
  R(8, "神殿连击柱", 84, 46, 0.24, 0.09, 12, 3, 5, ["banana", "boom"], "神殿连击柱", "连击柱上刻着你的名字!"),
  R(8, "圣火快切礼", 80, 30, 0.24, 0.08, 12, 3, 4, ["ice", "boom"], "神殿限时", "圣火燃烧的 30 秒!"),
  R(8, "守殿炸弹阵", 88, 48, 0.34, 0.11, 12, 2, 4, ["ice", "boom"], "神殿炸弹阵", "守殿的炸弹军团来了!"),
