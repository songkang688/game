...
.qz-jump-input { width: 76px; min-height: 44px; border: 2px solid #e0d6f2; border-radius: 12px; padding: 0 8px; font-family: inherit; font-size: 15px; font-weight: 800; box-sizing: border-box; }
.qz-jump-go { border: none; border-radius: 999px; padding: 8px 16px; font-family: inherit; font-size: 14px; font-weight: 900; cursor: pointer; background: #ffffffe6; box-shadow: 0 3px 0 rgba(120,120,160,.3); min-height: 44px; box-sizing: border-box; display: inline-flex; align-items: center; }
