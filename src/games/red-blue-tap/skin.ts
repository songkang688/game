...
export const RBT_TOKEN_DECL = [
  ...
  `--rbt-blue: ${PASTEL.vsBlue}`,
  `--rbt-blue-deep: ${shade(PASTEL.vsBlue, -12)}`,
  ...
  `--rbt-divider: linear-gradient(180deg, ${PASTEL.vsBlue} 0%, ${PASTEL.vsBlue} 44%, ${PASTEL.red} 56%, ${PASTEL.red} 100%)`,
...
.rbt-wrap .rbt-arena { background-image:
  ...
  radial-gradient(circle at 78% 16%, ${withAlpha(PASTEL.vsBlue, 0.08)} 0 2.6px, rgba(0,0,0,0) 3.1px),
  radial-gradient(circle at 62% 64%, ${withAlpha(PASTEL.starGold, 0.1)} 0 4px, rgba(0,0,0,0) 4.5px),
  radial-gradient(circle at 30% 78%, ${withAlpha(PASTEL.vsBlue, 0.08)} 0 2.8px, rgba(0,0,0,0) 3.3px),
