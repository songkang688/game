...
export const WORD_LEVELS: WordLevel[] = [
  {
    ...
    emoji: "🌿",
    cards: [
      { char: "日", pinyin: "rì", word: "太阳", emoji: "☀️", meaning: "天上的太阳，也指一整天" },
      { char: "月", pinyin: "yuè", word: "月亮", emoji: "🌙", meaning: "晚上挂在天上的月亮" },
      { char: "水", pinyin: "shuǐ", word: "水滴", emoji: "💧", meaning: "会流动、能喝的水" },
      { char: "火", pinyin: "huǒ", word: "火苗", emoji: "🔥", meaning: "烧起来又亮又烫的火" },
      { char: "山", pinyin: "shān", word: "大山", emoji: "⛰️", meaning: "地面上高高鼓起来的一大块" },
      { char: "田", pinyin: "tián", word: "田地", emoji: "🌾", meaning: "种庄稼的一块块地" },
      { char: "木", pinyin: "mù", word: "树木", emoji: "🌳", meaning: "树，也指木头做的东西" },
      { char: "花", pinyin: "huā", word: "花朵", emoji: "🌸", meaning: "草木开出来的漂亮花朵" },
      { char: "云", pinyin: "yún", word: "白云", emoji: "☁️", meaning: "天上一团一团的白云" },
      { char: "雨", pinyin: "yǔ", word: "下雨", emoji: "🌧️", meaning: "从云里落下来的水" },
      { char: "雪", pinyin: "xuě", word: "雪花", emoji: "❄️", meaning: "冬天飘下来的白色小花" },
      { char: "星", pinyin: "xīng", word: "星星", emoji: "⭐", meaning: "夜空里一闪一闪的小亮点" },
      { char: "电", pinyin: "diàn", word: "闪电", emoji: "⚡", meaning: "会发光、能让灯亮起来的电" },
      { char: "风", pinyin: "fēng", word: "大风", emoji: "🌬️", meaning: "看不见、能把树吹弯的风" },
      { char: "天", pinyin: "tiān", word: "天空", emoji: "🌤️", meaning: "头顶上的天，也指一天" },
      { char: "叶", pinyin: "yè", word: "树叶", emoji: "🍃", meaning: "长在树枝上的绿叶子" },
      { char: "草", pinyin: "cǎo", word: "小草", emoji: "🌱", meaning: "地上一片矮矮的绿草" },
      { char: "竹", pinyin: "zhú", word: "竹子", emoji: "🎋", meaning: "一节一节、又直又空的竹子" },
    ],
  },
  {
    name: "萌萌花园",
    ...
    cards: [
      ...
      { char: "鱼", pinyin: "yú", word: "小鱼", emoji: "🐟", meaning: "在水里游、用鳃呼吸的动物" },
      { char: "虫", pinyin: "chóng", word: "虫子", emoji: "🐛", meaning: "小小的爬虫，蚂蚁蝴蝶都算" },
      { char: "牛", pinyin: "niú", word: "小牛", emoji: "🐮", meaning: "有角、会耕地的大牲口" },
      { char: "羊", pinyin: "yáng", word: "小羊", emoji: "🐑", meaning: "身上长白毛、爱吃草的动物" },
      { char: "马", pinyin: "mǎ", word: "小马", emoji: "🐴", meaning: "跑得飞快、能骑的大动物" },
      { char: "狗", pinyin: "gǒu", word: "小狗", emoji: "🐶", meaning: "会看家、会摇尾巴的小动物" },
      { char: "猫", pinyin: "māo", word: "小猫", emoji: "🐱", meaning: "会抓老鼠、走路没声音的小动物" },
      { char: "兔", pinyin: "tù", word: "兔子", emoji: "🐰", meaning: "长耳朵、爱吃草的小动物" },
      { char: "猪", pinyin: "zhū", word: "小猪", emoji: "🐷", meaning: "鼻子圆圆、爱睡觉的家畜" },
      { char: "鸡", pinyin: "jī", word: "小鸡", emoji: "🐔", meaning: "会下蛋、天亮会打鸣的家禽" },
      { char: "鸭", pinyin: "yā", word: "鸭子", emoji: "🦆", meaning: "扁嘴巴、会游水的家禽" },
      { char: "龟", pinyin: "guī", word: "乌龟", emoji: "🐢", meaning: "背着硬壳、走得很慢的动物" },
      { char: "熊", pinyin: "xióng", word: "小熊", emoji: "🐻", meaning: "身子大、力气大的毛茸茸动物" },
      { char: "象", pinyin: "xiàng", word: "大象", emoji: "🐘", meaning: "鼻子长长、耳朵大大的动物" },
      { char: "虎", pinyin: "hǔ", word: "老虎", emoji: "🐯", meaning: "身上有花纹、很威风的猛兽" },
      { char: "蛙", pinyin: "wā", word: "青蛙", emoji: "🐸", meaning: "会跳会叫、专吃害虫的小动物" },
      { char: "鹅", pinyin: "é", word: "白鹅", emoji: "🦢", meaning: "脖子长长、会游水的家禽" },
    ],
  },
  {
    name: "星星花园",
    ...
    emoji: "✨",
    cards: [
      { char: "手", pinyin: "shǒu", word: "小手", emoji: "✋", meaning: "用来拿东西、写字的手" },
      { char: "口", pinyin: "kǒu", word: "嘴巴", emoji: "👄", meaning: "吃饭说话的嘴" },
      { char: "耳", pinyin: "ěr", word: "耳朵", emoji: "👂", meaning: "用来听声音的耳朵" },
      { char: "目", pinyin: "mù", word: "眼睛", emoji: "👀", meaning: "眼睛，用来看东西" },
      { char: "足", pinyin: "zú", word: "小脚", emoji: "🦶", meaning: "脚，用来走路跑步" },
      { char: "牙", pinyin: "yá", word: "牙齿", emoji: "🦷", meaning: "嘴里用来咬东西的牙" },
      { char: "心", pinyin: "xīn", word: "爱心", emoji: "❤️", meaning: "胸口会跳的心，也指心里想的" },
      { char: "人", pinyin: "rén", word: "人儿", emoji: "🧍", meaning: "人，大人小孩都是人" },
      { char: "门", pinyin: "mén", word: "大门", emoji: "🚪", meaning: "屋子上能开能关的门" },
      { char: "车", pinyin: "chē", word: "汽车", emoji: "🚗", meaning: "有轮子、能载人的车" },
      { char: "船", pinyin: "chuán", word: "小船", emoji: "⛵", meaning: "在水上走的交通工具" },
      { char: "伞", pinyin: "sǎn", word: "雨伞", emoji: "☂️", meaning: "下雨天撑开挡雨的伞" },
      { char: "书", pinyin: "shū", word: "书本", emoji: "📖", meaning: "一页一页装订起来看的书" },
      { char: "笔", pinyin: "bǐ", word: "铅笔", emoji: "✏️", meaning: "用来写字画画的笔" },
      { char: "灯", pinyin: "dēng", word: "灯泡", emoji: "💡", meaning: "天黑了用来照亮的灯" },
      { char: "球", pinyin: "qiú", word: "皮球", emoji: "⚽", meaning: "圆圆的、能拍能踢的球" },
      { char: "果", pinyin: "guǒ", word: "果子", emoji: "🍎", meaning: "树上结的果子" },
      { char: "米", pinyin: "mǐ", word: "大米", emoji: "🍚", meaning: "煮成饭吃的米" },
    ],
  },
];
...
export const POLYPHONE_CARDS: PolyphoneCard[] = [
  ...
  },
  {
    ...
    readings: [
      ...
      { pinyin: "hào", word: "爱好", sentence: "我的爱好是画画。", meaning: "喜欢" },
    ],
    decoy: "háo",
  },
  {
