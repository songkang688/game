/**
 * 海底大胃王 · 1.3 窗口3 第 3 轮视觉验收(终验) · 测试员机器扫描。
 *
...
const GUARDED_TESTS = ["visual-scan.test.ts", "visual-fix-r1.test.ts", "visual-deep-r2.test.ts", "visual-fix-r2.test.ts", "learner-copy.test.ts"];
