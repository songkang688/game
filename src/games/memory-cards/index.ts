...
.mmc-open { border: none; border-radius: 999px; padding: 8px 16px; min-height: 44px; font-size: 15px; font-weight: 900; color: #fff; cursor: pointer; font-family: inherit; background: linear-gradient(180deg, #6FA8DC, #4E86BC); box-shadow: 0 4px 0 #3C6C9C; }
.mmc-open:active { transform: translateY(2px); box-shadow: 0 2px 0 #3C6C9C; }
.mmc-toggle { border: none; border-radius: 999px; padding: 8px 14px; min-height: 44px; font-size: 14px; font-weight: 800; cursor: pointer; font-family: inherit; background: #ffffffd9; color: #7A5AA0; box-shadow: 0 3px 0 rgba(120,90,160,.25); white-space: nowrap; }
