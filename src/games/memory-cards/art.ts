...
// ---------------------------------------------------------------------------
// 七、1.3 追加的花絮图标(只在文件末尾新增;上面六套主题的 shape 数据一个数值没动)
// ---------------------------------------------------------------------------

/**
 * 1.3 视觉升级追加的原创花絮图标:**不进任何 THEME_PACKS.icons**——
 * `iconIndexOf` 按 `pack.icons.length` 取模,长度一变,独苗卡「伪装成别组图案」的
 * 老机关立刻改题。这四枚只做纯装饰(结算界面的小花车),等值升级不动玩法。
 */
export const BONUS_ICONS: Icon[] = [
  { name: "风筝", shapes: [poly("#F58FB0", 50, 6, 82, 40, 50, 74, 18, 40), line("#D96A92", 2, 50, 6, 50, 74), line("#D96A92", 2, 18, 40, 82, 40), line("#8A93A6", 2, 50, 74, 42, 84, 52, 92), c(42, 84, 4, "#F5C33B"), c(52, 92, 4, "#7FC4E8")] },
  { name: "灯笼", shapes: [box(46, 6, 8, 8, "#8A6034", 3), e(50, 50, 26, 28, "#E4585F"), box(36, 18, 28, 8, "#F0C25A", 3), box(36, 74, 28, 8, "#F0C25A", 3), line("#F2B8B0", 2, 40, 28, 40, 72), line("#F2B8B0", 2, 60, 28, 60, 72), line("#C9A227", 3, 50, 82, 50, 94)] },
  { name: "贝壳", shapes: [poly("#F4C9A8", 50, 90, 14, 42, 26, 24, 50, 16, 74, 24, 86, 42), line("#D89468", 3, 50, 90, 28, 30), line("#D89468", 3, 50, 90, 50, 16), line("#D89468", 3, 50, 90, 72, 30), c(50, 90, 6, "#D89468")] },
  { name: "橡果", shapes: [box(46, 8, 8, 12, "#5C4630", 3), e(50, 62, 20, 26, "#B07A46"), e(50, 34, 25, 15, "#7A5A34"), line("#5C4630", 2, 32, 30, 68, 30), c(43, 58, 4, "#D9B285")] },
];
