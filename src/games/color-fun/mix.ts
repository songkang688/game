...
export const RECIPES: Recipe[] = [
  ...
  // —— 中间色：一头很淡、一头很深，兑出来就落在中间那一档 ——
  // 原来写的是「浅绿 + 绿色 = 中绿」，可中绿（L 74.4）比这两支原料（94.6 / 85.1）都要深，
  // 等于教「两支淡的兑出一支更深的」。改配 浅绿 + 深绿（94.6 / 57.5），
  // 中绿正好落在两者中间，名字也就说得通了（窗口5 第2轮 W5R2-A-10）
  { a: "浅绿", b: "深绿", out: "中绿", why: "浅绿加深绿，兑出中间的中绿" },
