...
@media (max-height: 500px) {
  .mtf-illus { max-height: 40px; overflow: hidden; padding: 2px 6px; gap: 2px 4px; }
  .mtf-illus-unit { width: ${MIN_CROP_PX}px; height: ${MIN_CROP_PX}px; }
  .mtf-quizhost .qz-prompt { margin-top: 2px; }
  .mtf-quizhost .qz-choice { min-height: 46px; }
  .mtf-quizhost .qz-say { min-height: 44px; padding: 4px 12px; }
}
