...
`MAX_HOLD` 定在 1200 毫秒是按容错倒推的：200 世界单位摊到 1200 毫秒，1 单位 ≈ 6 毫秒，
落在半径 30 的台面上有 ±180 毫秒的余量，踩进 12 单位的完美圈需要 ±72 毫秒 ——
站住很宽松、完美要真功夫，正好是这类玩法该有的手感。
