...
- `README.md`（本文件）
- `step-30.md` … `step-54.md`（25 个游戏步，75 款 × 完整可复制提示词）
- `step-55.md` 冲突 / 串味 / 回归
- `step-56.md` 验收三人组第 1 轮
- `step-57.md` 验收三人组第 2 轮

## 七、自检清单（写稿用）

- [x] 步号从 30 连续编到 57，无跳号
- [x] 每步一文档、每步 A/B/C 三段完整可复制提示词（共 84 段）
- [x] 每代理 1 款游戏（55–57 为冲突/验收，仍三人）
- [x] 75 款无重复、无遗漏（现有 54 + 新 21）
- [x] 用户点名：gomoku / match-stars / rainbow-run / ocean-munch / xiangqi 写细
- [x] 新 21 款都有「第一版之后的精细化」
- [x] 派发头四句逐字（84/84）
- [x] 独占路径仅本目录
- [x] 象棋升级已有 `xiangqi`，未另开第二款
- [x] 2.5D/3D 按款决策，未全局硬上 3D
- [x] 游戏侧只接 skip/unlock，密码门留给 A 档平台步
