...
> **第 17 轮更新**。基线：`origin/game-1.3 = 206d0522`（主干五轮稳）。**#1（e75a）首轮交卷 PT-1…PT-4 已入池**（§3.0/§6.8）：bubble-aim 竖屏划不动/平板地图窄柱/ba-cs 平板画布小窗/candy-swing 竖屏裁 18——并带来**大笔干净账**（76 款 × 竖屏两档+矮横屏真触摸滚动全绿，下轮不必重量）。在途认领潮：**9a87 一单连修 N-99/N-97/N-100/N-109**；**1cd5 实修拟名 N-117/118/120 与 N-124 打靶**，其 r23/r24 笔记把号池推进到 **N-134**（PR #87/#90/#91 各占段）。主干水位仍 N-109；**勿开 N-110…116**；新伤先并号、再问 1cd5 台账（其「未合 PR 号视为已占」规则与本文一致）。
...
- **N-99 数独盘面**：**四路**——5c27 被派 / 4e78 内滚 / b255 模式条 / **9a87 `b7677155`「数独盘可滚」+守门测试**——先合版生效
- **N-100 误滚卷顶**：**三路**——5c27 被派 / b255 部分修复 / **9a87「l99 进场锚定 sticky+钳滚距」**——先合版生效；残余页签面 1cd5 N-117 已实修在途
- **N-97 农场深关 / N-109 root 门收档**：9a87 同单认领（N-97 答案钉底、N-109 余力项+rootGate 测试）——**两号从空白转在途**，勿另修
...
| 1cd5 `9e78f25f`+`ee4ebe70`+r23/r24 笔记（第 17 轮新收） | 实修 N-117/118/120（页签徽章/去 136px 盲区/触摸滚动+守门）与 N-124 打靶键排钉底；r23 开 N-129…131、r24 开 N-132…134 | 在途；**号池水位推进到 N-134**（未合 PR 号视为已占）；N-117/118/120 从「等定名」转「在途实修」 |
...
## 七、第 17 轮给 #1/#2 的可勾选执行清单（两位都在 r2）
...
- [ ] **认领潮后零动作清单**：N-99/N-97/N-100/N-109（9a87 一单四号）、N-117/118/120（1cd5 实修）、顶栏挤扁（b255/4e78）——全部只等先合版，碰 = 打回
...
- [ ] 交卷：水位只增不减（基准 **1194/19496**）+ 红灯守门绿；🟡/🔧 分开列；报告进当轮文件
