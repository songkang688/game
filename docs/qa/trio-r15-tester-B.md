...
## 915×412（preview :4186）

Vite 热更后：`max-height:500px` matches。N-75 手牌 top 514→~410（贴线，chrome 再垫到 108）。N-84 闯关键 307–402 IN crop 0。N-85 305–403 IN（crop 172）。N-80 256–366 IN。N-83 悔棋 369 切 1px、确认 421 仍 FOLD。N-76/78/79/81/82 以源码守门+本轮入口脚本为准。
