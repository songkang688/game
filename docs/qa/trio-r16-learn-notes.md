...
| r13 A | `215958e` | **N-63** 模式条移出地图卷轴、**C-6** pads 钉舞台、**N-37** quizhost 收高、N-47 残留 40→44 **源码已合**。 |
| r14 A | `87c5aff` / `44d9e50` | **N-68** 三图横排、**N-73** 视奏琴键、N-63/C-6/N-37 补笔 **源码已合**（915：三图末格 336、哆 346–411）。撞车取 r13 先合版。勿第三套。 |
