...
本机续修增量：N-100 选关头/工具 sticky 扩到 `840 && min-height:501`（不覆盖 500 档）；仓鼠/围棋/翻翻乐/扫雷双人/勇者大厅平板钉底或钳盘；保龄暂停/回选、射击预览、红蓝竞速返回、对数对决返回、数独键 后盖 44；贪吃蛇 840 加 `min-height:501` 以免盖掉 N-81 的 fixed。下一轮优先：其余模式键 44、商店底栏、390 竖屏划不动的剩余 l99 HUD。
